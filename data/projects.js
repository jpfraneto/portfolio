...
export const projects = [
  {
    ...
    technologies: ['html', 'css', 'javascript', 'mongodb', 'nodejs'],
    shortDescription:
      'Eternal thread of music that always has one and only one (different) piece of music in a state that I call the present. ',
  ...
  },
  {
    ...
    shortDescription:
      'Similar to Human Music, but here the spirit is to have interesting and entertaining content, and each user has a more organized profile on which to add her favorite pieces of youtube content so that they can be accesed later.',
    lessonsLearned:
    ...
    technologies: ['nextjs', 'react', 'mongodb', 'nodejs'],
    prodUrl: 'https://www.theinfinitejest.tv',
    videoUrl: 'https://www.youtube.com/watch?v=Udvrfg1-YPg&t=248s',
  ...
  {
    shortDescription:
      'For doing Deep Work sessions, inspired by the book from Cal Newport. Each session can be assigned to a particular project, and it has its specific goals for focusing the work made by the user.',
    name: 'Drip Work',
    lessonsLearned: '',
    ...
    image: dripWork,
    videoUrl: 'https://www.youtube.com/watch?v=KVgSkoPVnhQ&t=1s',
    technicalDescription:
  ...
  },
  {
    ...
    technologies: ['gatsbyjs', 'react', 'graphql'],
  ...
  },
  {
    ...
    lessonsLearned: '',
    shortDescription:
      'Mothership of all my creations. The goal of this place is to serve as the frame for building an original app every month, and shipping it (the most important part) every full moon day. ',
  ...
  },
  {
    ...
    technologies: ['redux', 'react', 'nodejs', 'mongodb'],
  ...
  {
    shortDescription:
      'Place on which I store all the stuff that is important in my life, so that I can access it from anywhere. It is my notion account but in the web.',
    name: 'Second Brain',
    lessonsLearned: '',
    sourceCodeUrl: 'https://github.com/jpfraneto/jpfraneto',
    url: 'jp.jpfraneto.com',
    technologies: ['nextjs', 'mongodb'],
    videoUrl: 'https://www.youtube.com/watch?v=vmVgy_lMm9I&t=4s',
  ...
  {
    shortDescription:
      'Place for Kundalini Yoga teachers to store Kriyas and be able to practice them. The app has an integrated timer in each class, so that they can focus on the important part of it: the students.',
    name: 'Rudra KY',
    lessonsLearned: '',
  ...
  {
    shortDescription:
      'Platform for users to share music from the three services I mainly use: Spotify, Soundcloud and Youtube. Create playlists and share them with your friends, and also have a personal library with pieces of music from these three worlds.',
    ...
    image: worldsOfSound,
    technicalDescription: '',
    videoUrl: 'https://www.youtube.com/watch?v=3REwFXlYfug&t=2s',
    description:
  ...
  {
    shortDescription:
      'The starting point of my podcast is the question: If you died tomorrow, what album would you take to the other side? This is the homepage of that project, because my goal is to have random people, from all over the world, as a guest. It will evolve towards that, and this website will select the next guest randomly from all of those that have shared music here.',
    name: 'Timeless Integration Podcast',
    lessonsLearned: '',
    sourceCodeUrl: 'https://github.com/jpfraneto/human-music-podcast',
    url: 'podcast.human-music.com',
    technologies: ['amazonS3', 'mongodb', 'react', 'nodejs'],
